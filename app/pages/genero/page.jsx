            ...
            <div className="col-span-12 md:col-span-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex space-x-4 mb-8">
                  {genres.map((genre) => (
                    <div
                      ...
                      onClick={() => setSelectedGenre(genre)} // Manejo de selección por clic
                      className={`cursor-pointer md:w-24 md:h-24 sm:w-12 sm:h-12 w-full h-auto max-w-full max-h-full m-1 ${selectedGenre?.name === genre.name ? 'ring-4 ring-orange-500' : ''
                        }`}
                    >
                      <img
                        src={genre.image}
                ...
                <button
                  ...
                  className={`py-2 px-6 rounded ${selectedGenre
